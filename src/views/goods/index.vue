    ...
    <van-action-sheet v-model="showPannel" :title="mode === 'cart' ? '加入购物车' : '立刻购买'">
      <div class="product">
        ...
        <div class="showbtn" v-if="detail.stock_total > 0">
          <div class="btn" @click="handleAdd" v-if="mode === 'cart'">加入购物车</div>
          <div class="btn now" @click="handleBuy" v-if="mode === 'buyNow'">立刻购买</div>
        </div>
...
import { getGoodsComments, getGoodsDetail } from '@/api/goods'
...
export default {
  ...
  methods: {
    ...
    async getComments () {
      const { data: { list, total } } = await getGoodsComments(this.goodsId, 3)
